...
The goal of this exercise is to recreate the function accuracy_score of sklearn.metrics and to learn what represents
the accuracy and how to measure it.
