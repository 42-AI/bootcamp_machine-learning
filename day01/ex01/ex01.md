...
## AI Classics: 
*These exercises are key assignments from previous days. They are mandatory to continue your learning. You should not try to go further if you haven't completed them.*
...
It is the same thing as ex07 of day00 but this time you have to calculate it using your dear friend linear algebra.  
