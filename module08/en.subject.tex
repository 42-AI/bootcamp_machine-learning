...
You may have to take a look at Scikit-Learn's implementation of logistic regression and noticed that the \textbf{sklearn.linear_model.LogisticRegression} class offers a lot of options.
...
You will use the \textbf{solar_system_census_dataset}. 
...
For a more visual version, you can add an option to your previous confusion_matrix_ function to return a \texttt{pandas.DataFrame} instead of a numpy array.

\subsection{Instructions:}

In the \texttt{confusion_matrix.py} file, write the following function as per the instructions below:
\begin{minted}[bgcolor=darcula-back,formatcom=\color{lightgrey},fontsize=\scriptsize]{python}
